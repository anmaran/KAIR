...
This repository is forked from (https://github.com/cszn/KAIR) and was changed for Sentinel-2 satellite images. Only RGB channels were used and super-resolution was made from 20m to 10m.
